...
abstract class ApiTestCase extends WebTestCase
{
     ...
     */
    public function getResponse($method, $uri, $params = [], $files = [], $server = [], $content = null, $changehistory = true)
    {
     ...
     */
    public function getJson($method, $uri, $params = [], $files = [], $server = [], $content = null, $changehistory = true)
    {
