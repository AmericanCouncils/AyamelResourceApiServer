...
/**
 * A listener that monitors input/output for all requests under `/rest/`.  Enforces accept header, logs requests and handles exceptions thrown by ApiControllers.
 *
...
class RestWorkflowSubscriber implements EventSubscriberInterface {
	...
	/**
	 * Array of content-type headers to used, keyed by serialization format.
	 *
	 * @var array
	 */
	...
	public function onApiView(GetResponseForControllerResultEvent $e) {
		...
		//TODO: consider implementing response cache logic here, maybe getting via some $data['__response'] hash received from controllers, and removing before encoding?
